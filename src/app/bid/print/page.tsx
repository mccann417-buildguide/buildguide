      ...
      {!base ? (
        <div className="rounded border p-4 text-sm">
          ...
          <div className="mt-2 text-neutral-600">
            (MVP note: this print page reads localStorage. If you need cross-device printing, we’ll store reports on the server.)
          </div>
        </div>
      ) : (
        <>
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5">
              {base.redFlags.map((x, i) => <li key={i}>{x}</li>)}
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5">
              {base.included.map((x, i) => <li key={i}>{x}</li>)}
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc pl-5">
              {base.missing.map((x, i) => <li key={i}>{x}</li>)}
            </ul>
          </section>
          ...
          {detail ? (
            <>
              ...
              {detail.marketComparison ? (
                <section className="space-y-2">
                  ...
                  <div className="text-sm">
                    <div><b>Area:</b> {detail.marketComparison.area}</div>
                    <div>
                      <b>Expected range:</b> {detail.marketComparison.expectedRange.low} · {detail.marketComparison.expectedRange.mid} · {detail.marketComparison.expectedRange.high}
                    </div>
                    <div><b>Verdict:</b> {detail.marketComparison.verdict}</div>
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc pl-5">
                  {detail.deeperIssues.map((x, i) => <li key={i}>{x}</li>)}
                </ul>
              </section>
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc pl-5">
                  {detail.paymentScheduleNotes.map((x, i) => <li key={i}>{x}</li>)}
                </ul>
              </section>
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc pl-5">
                  {detail.contractWarnings.map((x, i) => <li key={i}>{x}</li>)}
                </ul>
              </section>
              ...
              <section className="space-y-2">
                ...
                <ul className="list-disc pl-5">
                  {detail.negotiationTips.map((x, i) => <li key={i}>{x}</li>)}
                </ul>
              </section>
            ...
            <div className="rounded border p-4 text-sm">
              ...
              <div className="mt-2 text-neutral-600">
                Generate the Full Report once, then this page will include it.
              </div>
            </div>
          )}
        </>
